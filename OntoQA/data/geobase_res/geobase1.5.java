...
public class Test {
	...
	public static void main(String[] args) throws Exception {
		...
		Resource cityResource = model.getResource(geo + "city");
		Property inStateProperty = model.getProperty(geo + "inState");
		...
		for(Statement stmtTmp : resList){
			...
			if(cityNode.hasProperty(labelProperty) == false){
				...
				cityNode.addProperty(typeProperty, cityResource);
				cityNode.addProperty(inStateProperty, stateNode);
			}
